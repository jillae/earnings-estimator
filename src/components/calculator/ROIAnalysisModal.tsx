...
const ROIAnalysisModal: React.FC<ROIAnalysisModalProps> = ({ open, onOpenChange }) => {
  const {
    selectedMachine,
    machinePriceSEK,
    cashPriceSEK,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>ROI Analys</DialogTitle>
          <DialogDescription>
            Avancerad lönsamhetsanalys baserad på dina kalkylatorsettings
          </DialogDescription>
          {selectedMachine && (
...
export default ROIAnalysisModal;
  ...
  return <div className="w-full space-y-6">
      {selectedMachine ? <>
          ...
          <div className="relative">
            ...
            <div className="glass-card animate-slide-in pt-2" style={{
          animationDelay: '200ms'
        }}>
              <ClinicSizeSelector clinicSize={clinicSize} netYearlyResult={netResults?.netPerYearExVat || 0} onChange={setClinicSize} hoveredInput={hoveredInput} onHoveredInputChange={onHoveredInputChange} />
            </div>
          </div>
          ...
          animationDelay: '200ms'
              ...
              <TreatmentSettings treatmentsPerDay={treatmentsPerDay} customerPrice={customerPrice} onTreatmentsChange={setTreatmentsPerDay} onCustomerPriceChange={setCustomerPrice} hoveredInput={hoveredInput} onHoveredInputChange={onHoveredInputChange} />
            </div>
          </div>

          {/* Växla maskin */}
          <MachineSelector machines={machineData} selectedMachineId={selectedMachineId} onChange={setSelectedMachineId} />

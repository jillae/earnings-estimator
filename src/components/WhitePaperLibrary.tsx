...
const WhitePaperLibrary: React.FC = () => {
  return (
    <div className="container max-w-7xl mx-auto px-4 sm:px-6 py-12 mt-8 animate-fade-in">
      <div className="glass-card">
        ...
        <div className="mt-10 text-center">
          <div className="inline-block">
            <img 
              src="/lovable-uploads/cd40681e-4fda-4789-b9a9-196b4ab2ded2.png" 
              alt="Erchonia Logo" 
              className="h-16 mx-auto mb-4" 
            />
          </div>
          <p className="text-sm text-slate-600 mt-4">
            Erchonia är världsledande inom lågeffektslaserteknik. 

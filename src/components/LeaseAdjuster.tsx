        ...
        <div className="flex items-center gap-4">
          <div className="flex-1">
            <RollingValueDisplay 
              ...
              showTrendIcon={true}
              trendDirection={currentSliderStep === 2 ? 'neutral' : currentSliderStep === 0 ? 'up-steep' : currentSliderStep === 1 ? 'up-mild' : currentSliderStep === 3 ? 'up-mild' : currentSliderStep === 4 ? 'up-steep' : 'up'}
          ...
          <div className="flex-1">
            <RollingValueDisplay 
              ...
              showTrendIcon={true}
              trendDirection={currentSliderStep === 2 ? 'neutral' : currentSliderStep === 0 ? 'down-steep' : currentSliderStep === 1 ? 'down-mild' : currentSliderStep === 3 ? 'down-mild' : currentSliderStep === 4 ? 'down-steep' : 'down'}
              animationStyle="rolodex"
            />
          </div>
        </div>
